...
<?php
    ...
    if(isset($_POST['sellItem'])){
        ...
        if($quantity==null){
            ...
            /*if($salesList->addItemToSalesList()){
                $newNumber=$item_number-$quantity;
                Item::updateItemNumber($id, $newNumber);
                echo '<div class="message"><h4> successful '.$totalPrice.' EP ' .$newNumber.'</h4></div>';
            }else{
                echo '<div class="message"> error in selling process</h4></div>';
            }
            */
